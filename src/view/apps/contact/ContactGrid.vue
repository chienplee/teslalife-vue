  ...
  setup() {
    ...
    const handleEditOk = values => {
      ...
      updateUsers.map(user => {
        if (user.id === localState.update.id) {
          const updateUser = user;
          updateUser.id = localState.update.id;
          ...
          updateUser.time = localState.update.time;
          updateUser.img = localState.update.img;
          updateUser.stared = localState.update.stared;
        }
        return true;
      });
