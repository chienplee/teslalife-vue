<template>
  <div>
    <sdPageHeader :breadcrumb="false" title="Support Center">
              ...
              <a-row align="middle">
                <a-col :lg="16" :sm="14" :xs="24">
                  <div class="sDash_support-content">
                    <h2 class="sDash_support-content__title">
                      Hello, We are here to help
                    </h2>
                    <p>
                      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                    </p>
                    <sdButton class="btn-ticket" size="large" type="primary" raised>
                ...
                <a-row :gutter="30">
                  <a-col :lg="8" :xs="24">
                    <div class="sDash-support-link-item">
                      ...
                      <h4 class="sDash-support-link-item__title">
                        Knowledgebase
                      </h4>
